...
public class Logln {
	...
	private static ThreadLocal<ThreadLocalElement> thisthreadlocal = new ThreadLocal<ThreadLocalElement>() {
			protected synchronized ThreadLocalElement initialValue() {
				return null;
			};
		};
	/**
